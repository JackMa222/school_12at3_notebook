...
from .models import PaymentBody, Organiser, Event, Match, MatchOfficial, Payment, Role, Person
...
class MatchOfficialAdmin(admin.ModelAdmin):
    list_display = ['person', 'match']
    filter_horizontal = ['roles']
    search_fields = ['person__name', 'match__title']
